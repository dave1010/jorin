...
Thanks for considering contributing to jorin! Here are some guidelines to make
contributions smooth and easy to review.

- Follow the existing code style and run `gofmt -w .` before committing.
